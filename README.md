...
# step24: Controllerを単体テストする

目標：e2eテストで書いた正常系をまんま移植

- まずはTodoServiceをモック化

/api/src/todo/todo.controller.spec.tsを以下で編集する

```ts
import { Test, TestingModule } from '@nestjs/testing';
import { TodoController } from './todo.controller';
import { TodoService } from './todo.service'; // 追加
import { Todo } from '../entities/todo.entity'; // 追加
import { CreateTodoDto, UpdateTodoDto } from './todo.dto'; // 追加
import { PaginationDto, PaginationOptionsDto } from './../dtos/pagination.dto'; // 追加

describe('TodoController', () => {
  let controller: TodoController;
  let fakeTodoService: Partial<TodoService>; // 追加
...
```ts
import Dayjs from '../util/dayjs'; // 追加
...
# step26: Serviceを単体テストする

目標：e2eテストで書いた正常系をまんま移植

- まずはRepositoryをモック化

/api/src/todo/todo.service.spec.tsを以下で編集する
